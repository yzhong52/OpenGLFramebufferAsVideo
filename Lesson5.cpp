...
// Yuchen: Using OpenCV ot Save the Scene to video
#include "opencv\cv.h"
...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	// Yuchen: Saving Framebuffer Using OpenCV
	saveFramebuffer();
...
void saveFramebuffer(){
	...
	static int const total_frame = 100;
	if( fid==0 ) {
		RECT WindowRect; 
